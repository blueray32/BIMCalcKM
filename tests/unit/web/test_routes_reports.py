"""Tests for bimcalc.reporting.routes - Reports routes.
...
from bimcalc.reporting import routes as reports
...
class TestReportsPage:
    ...
    @patch("bimcalc.reporting.routes.get_session")
    ...
    @patch("bimcalc.reporting.routes.compute_financial_metrics")
    @patch("bimcalc.reporting.routes.get_session")
    @patch("bimcalc.web.dependencies.get_config")
...
class TestStatisticsPage:
    ...
    @pytest.mark.skip(
        reason="Statistics template requires complex data - better in integration"
    )
    @patch("bimcalc.reporting.routes.generate_report")
    @patch("bimcalc.reporting.routes.get_session")
    @patch("bimcalc.web.dependencies.get_config")
...
def test_router_has_correct_routes():
    ...
    assert "/api/reports/custom/generate" in routes

    # Should have 4 routes total
    assert len(reports.router.routes) == 4
