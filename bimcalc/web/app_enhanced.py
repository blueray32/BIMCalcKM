...
from bimcalc.web.routes import revisions    # Phase 3.14 - Revisions router
from bimcalc.web.routes import integrations # Phase 3.15 - Integrations router
...
# Phase 3.14 - Revisions router (replaces inline revisions routes at lines 400, 482)
app.include_router(revisions.router)

# Phase 3.15 - Integrations router (replaces inline ACC integration routes at lines 575, 582, 594)
...
# ============================================================================
# Revisions Routes
# Phase 3.14 - Extracted to bimcalc.web.routes.revisions
# ============================================================================
# REFACTORED: Revisions routes moved to bimcalc.web.routes.revisions (Phase 3.14)
# - GET /api/revisions -> revisions.get_revisions()
# - GET /revisions     -> revisions.revisions_page()
...
# ============================================================================
# Scenario Planning
# Phase 3.12 - Extracted to bimcalc.web.routes.scenarios
# ============================================================================

# REFACTORED: Scenario routes moved to bimcalc.web.routes.scenarios (Phase 3.12)
# - GET /api/scenarios/export  -> scenarios.export_scenarios()
# - GET /scenarios             -> scenarios.scenario_page()
# - GET /api/scenarios/compare -> scenarios.compare_scenarios()
...
# ============================================================================
# Prices Routes
# Phase 3.11 - Extracted to bimcalc.web.routes.prices
# ============================================================================
# REFACTORED: Price routes moved to bimcalc.web.routes.prices (Phase 3.11)
# - GET /prices/history/{item_code} -> prices.price_history()
# - GET /prices-legacy              -> prices.prices_list()
# - GET /prices/export              -> prices.prices_export()
# - GET /prices/{price_id}          -> prices.price_detail()
...
# ============================================================================
# Crail4 Configuration Routes
# Phase 3.13 - Extracted to bimcalc.web.routes.crail4
# ============================================================================
# REFACTORED: Crail4 routes moved to bimcalc.web.routes.crail4 (Phase 3.13)
# - GET  /crail4-config                    -> crail4.crail4_config_page()
# - POST /crail4-config/save               -> crail4.save_config()
# - POST /crail4-config/test               -> crail4.test_connection()
# - POST /crail4-config/sync               -> crail4.sync_prices()
# - GET  /crail4-config/status/{job_id}    -> crail4.sync_status()
# - POST /crail4-config/mappings/add       -> crail4.add_classification_mapping()
