...
def upgrade() -> None:
    ...
    op.add_column(
        "projects", sa.Column("region", sa.Text(), nullable=False, server_default="EU")
    )

    # New indexes for training examples (safe to keep)
    op.create_index(
        op.f("ix_training_examples_org_id"),
        "training_examples",
        ["org_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_training_examples_price_item_id"),
        "training_examples",
        ["price_item_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_training_examples_source_item_id"),
        "training_examples",
        ["source_item_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_compliance_results_rule_id"), table_name="compliance_results"
    )
