...
def upgrade() -> None:
    ...
    op.add_column('items', sa.Column('price_item_id', sa.Uuid(as_uuid=True), nullable=True))
    op.create_index(op.f('ix_items_price_item_id'), 'items', ['price_item_id'], unique=False)
