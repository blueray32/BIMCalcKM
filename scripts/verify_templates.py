...
async def verify_templates():
    try:
        ...
        try:
            # Jinja2 loader check
            source, filename, uptodate = templates.env.loader.get_source(templates.env, "reports.html")
        ...
        try:
            source, filename, uptodate = templates.env.loader.get_source(templates.env, "ingest.html")
