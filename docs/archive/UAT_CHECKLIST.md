...
## 8. Document Analysis (Phase 10)
- [ ] **Upload Document**:
    - [ ] Go to **Executive Dashboard** -> **Documents** tab.
    - [ ] Upload a PDF (e.g., invoice).
    - [ ] **Verify**: Document appears in list with "Completed" status.
- [ ] **View Results**:
    - [ ] Click **View Results** on the uploaded document.
    - [ ] **Verify**: Modal opens showing extracted line items (Description, Qty, Price).
