...
from bimcalc.db.models import Base, ItemModel, PriceItemModel, ProjectModel
...
async def verify_labor_config():
    async with AsyncSessionLocal() as session:
        ...
        assert metrics.blended_labor_rate == 50.0, f"Expected 50.0, got {metrics.blended_labor_rate}"
        assert metrics.total_labor_cost == expected_cost_default, f"Expected {expected_cost_default}, got {metrics.total_labor_cost}"
        ...
        assert metrics.blended_labor_rate == 100.0, f"Expected 100.0, got {metrics.blended_labor_rate}"
        assert metrics.total_labor_cost == expected_cost_new, f"Expected {expected_cost_new}, got {metrics.total_labor_cost}"
